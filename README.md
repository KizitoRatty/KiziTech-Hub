# KiziTech-Hub# KiziTech Hub – Professional UDP Tunnel Manager
...
```bash
wget -qO /tmp/install.sh https://raw.githubusercontent.com/KizitoRatty/KiziTech-Hub/main/install.sh && bash /tmp/install.sh
